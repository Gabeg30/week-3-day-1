...
# print(sent.upper())
# print(sent[2:6])
# print(sent.replace("basketball", "volleyball"))
# # Input Practice:
...
# objects= input("name 3 objects in the room you are in right now.")
# print(objects)
# object1= "phone"
# object2= "water bottle"
# object3= "bookbag"
# print("I have my " + object1 + " in my pocket, my " + object2 + " on my desk and my " + object3 + " under my desk")
